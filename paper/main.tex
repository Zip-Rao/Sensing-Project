...
inside the calibrated response window.  In numerical closed-loop tests for a
20-MHz target shift, the resulting protocol reaches a 5.2-kHz independently
verified residual in six iterations and 984 counted solver calls, compared
...
\input{sections/02_transient_discriminator}
\input{sections/03_kernel_correction}
\input{sections/04_feedback_protocol}
\input{sections/05_numerical_results}
