...
Fig.~\ref{fig:system-protocol}(d), supplemented by
...
a scheduled audit returns the protocol to \textsc{Verify}; a large frequency
jump or loss of the local reference enters \textsc{Reacquire}.
