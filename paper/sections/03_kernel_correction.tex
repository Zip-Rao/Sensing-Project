...
To obtain the second bias--frequency point required for the secant estimate,
the controller proposes the bounded one-sided step
%
\begin{equation}
\Phi_1^{\mathrm{prop}}
=
...
\in\{-1,+1\}$
is the known local monotonic direction. The applied value $\Phi_1$ is
